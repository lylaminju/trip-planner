...
Trip Planner should feel like one connected planning surface: itinerary timing,
...
temporary product name, primary request-access action, secondary sign-in link,
and optional sample-preview anchor.
