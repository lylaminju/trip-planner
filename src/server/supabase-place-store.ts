...
import type { ScheduledVisit } from "@/lib/trip-date-shift";
import {
...
const PLACE_COLUMNS =
  "id, trip_id, name, address, google_maps_url, google_place_id, google_place_token, google_internal_ids, source_list_url, latitude, longitude, notes, links, image_url, image_credit, fallback_emoji, created_at, updated_at";
