...
export function EllipsisIcon() {
  return (
    <svg viewBox="0 0 24 24" aria-hidden="true" focusable="false">
      <circle cx="5" cy="12" r="1.7" style={{ fill: "currentColor", stroke: "none" }} />
      <circle cx="12" cy="12" r="1.7" style={{ fill: "currentColor", stroke: "none" }} />
      <circle cx="19" cy="12" r="1.7" style={{ fill: "currentColor", stroke: "none" }} />
    </svg>
  );
}
